<?php
  if(isset($_GET["trainerId"])) {
    ...
    if( $rows > 0) {
      ...
      $trainerParentCategory = $row["trainerParentCategory"];
      $willingToTravel = $row["willingToTravel"];
      $willingToTravelArray = explode("|",$willingToTravel);
    }   
  }
?>
<!DOCTYPE html>
  ...
  <section id="contact">
    <div class="container">
      <div class="row">
        ...
        <form name="editTrainerForm" method="post" enctype="multipart/form-data">
          <div class="row">
                ...
                <div class="panel-heading">Trainers Category</div>
                  <div class="panel-body">
                    <div class="form-group">
                      ...
                      <select id="trainerParentCategory" name="trainerParentCategory" class="form-control" value="<?php echo $row["trainerParentCategory"];?>"  required>
                        <option value="">Select Category</option>
                        <option value="<?php echo $row["trainerParentCategory"];?>" selected><?php echo $row["trainerParentCategory"];?></option>
                      ...
                      <div class="form-group">
                          ...
                          <select id="subCategory" name="subCategory" class="form-control" value="<?php echo $row["subCategory"];?>" required>
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="form-group">
                      ...
                      <select id="selectSoftSkills" name="selectSoftSkills" class="form-control" value="<?php echo $row["selectSoftSkills"];?>" required>
                        <option value="">-- select --</option>
                        <option value="<?php echo $row["selectSoftSkills"];?>" selected><?php echo $row["selectSoftSkills"];?></option>
                      </select>
                      <input type="text" name="selectSoftSkillsOther" id="selectSoftSkillsText" class="form-control" 
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      ...
                      <textarea name="profJourney" id="profJourney" rows="6" class="form-control" placeholder="Brief About Your Professional Journey" required><?php echo $row['profJourney'];?></textarea>
                  </div>
                  <div class="form-group">
                      <label for="Total Experience in yrs" class="col-form-label">Total Experience in yrs</label>
                      <input type="text" value="<?php echo $row['totalExperience'];?>" name="totalExperience" id="totalExperience" class="form-control" maxlength="5" placeholder="Total Experience in yrs" onkeypress="return isNumberKey(event)" required>
                  </div>
                  <div class="form-group">
                ...
                <div class="panel-body">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $row["emailId"];?>" name="emailId" id="emailId" class="form-control" placeholder="Email Id" required>
                    </div>
                    <div class="form-group">
                        <label for="Full Postal Address" class="col-form-label">Full Postal Address</label>
                        <input type="text" value="<?php echo $row["fullPostalAddress"];?>" name="fullPostalAddress" id="fullPostalAddress" class="form-control" placeholder="Full Postal Address" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="state" id="state" class="form-control" value="<?php echo $row["state"];?>" required>
